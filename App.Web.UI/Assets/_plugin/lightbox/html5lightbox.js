    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.options = jQuery.extend({
                ...
                fadespeed: 400,
                jsfolder: jsFolder,
                skinsfoldername: "/Assets/_plugin/lightbox/",
            ...
            inst.createMarkup = function() {
                ...
                inst.$lightboxBox.append("<div id='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;margin-top:-16px;margin-right:-16px;'><img src='/Assets/_plugin/lightbox/" + inst.options.closeimage + "'></div>");
